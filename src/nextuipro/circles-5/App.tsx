...
const data: CircleChartProps[] = [
  {
    ...
    color: "default",
    total: 1358,
    chartData: [{name: "Active Users", value: 780, fill: "hsl(var(--nextui-primary))"}],
  },
  {
    title: "Revenue",
    color: "primary",
    total: 2450,
    chartData: [{name: "Monthly", value: 1840, fill: "hsl(var(--nextui-primary))"}],
  },
  {
    title: "Engagement",
    color: "secondary",
    total: 4200,
    chartData: [{name: "Daily Views", value: 3150, fill: "hsl(var(--nextui-secondary))"}],
  },
  {
    title: "Conversion",
    color: "success",
    total: 1000,
    chartData: [{name: "Sales", value: 750, fill: "hsl(var(--nextui-success))"}],
  },
  {
    title: "Bounce Rate",
    color: "warning",
    total: 100,
    chartData: [{name: "Exits", value: 80, fill: "hsl(var(--nextui-warning))"}],
  },
  {
    title: "Errors",
    color: "danger",
    total: 500,
    chartData: [{name: "Issues", value: 450, fill: "hsl(var(--nextui-danger))"}],
  },
];
